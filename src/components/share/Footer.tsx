...
const Footer = () => {
  return (
    <div className="bg-[#130e25] relative text-white">
      <div className=" py-14 px-5 lg:px-20">
        ...
        <div className="flex justify-center pt-10 border-t border-gray-400">
          <p>
            2023 &copy; <span className="text-2xl text-orange-600"> Life</span>
            <span className="text-green-500 text-2xl">Care</span> All Rights
            Reserved.
          </p>
        </div>
      </div>
